...
procedure MILDRIVER_VersionNr(var version:_BYTE);
                              cdecl; external 'PCIMilTreiberS.dll';

function PCI_PCIcardCount():_DWORD;cdecl; external 'PCIMilTreiberS.dll';

function PCI_DriverOpen(CardNr:_BYTE):_DWORD;cdecl; external 'PCIMilTreiberS.dll';
